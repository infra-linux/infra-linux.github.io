...
1. [Git — guia prático](git.md): branches, revisão e colaboração segura.
2. [Docker](docker.md): imagens, containers, volumes e redes.
3. [Kubernetes](kubernetes/): comece por KUBECONFIG e kubectl; depois avance para Pods, Deployments, Services e Ingress.
4. [CI/CD](cicd.md): conecte a validação, a criação de imagens e o deploy.
5. [Ansible](ansible.md): automatize configurações repetitivas de infraestrutura.
