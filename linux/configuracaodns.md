...
1. [1. Cenário](#1-cenario)
2. [Servidores](#servidores)
3. [2. Objetivo](#2-objetivo)
4. [3. Instalar o BIND](#3-instalar-o-bind)
5. [4. Verificar o serviço](#4-verificar-o-servico)
6. [5. Verificar a conectividade de rede](#5-verificar-a-conectividade-de-rede)
7. [6. Testar os DNS corporativos](#6-testar-os-dns-corporativos)
8. [7. Importante: DNS público direto pode estar bloqueado](#7-importante-dns-publico-direto-pode-estar-bloqueado)
9. [8. Configurar o BIND](#8-configurar-o-bind)
10. [9. Entendendo os principais parâmetros](#9-entendendo-os-principais-parametros)
11. [`listen-on`](#listen-on)
12. [`allow-query`](#allow-query)
13. [`forwarders`](#forwarders)
14. [`forward only`](#forward-only)
15. [10. Criar a zona interna](#10-criar-a-zona-interna)
16. [11. Verificar permissões da zona](#11-verificar-permissoes-da-zona)
17. [12. Validar a configuração](#12-validar-a-configuracao)
18. [13. Reiniciar o BIND](#13-reiniciar-o-bind)
19. [14. Verificar se o BIND está escutando na porta 53](#14-verificar-se-o-bind-esta-escutando-na-porta-53)
20. [15. Testar a zona interna](#15-testar-a-zona-interna)
21. [16. Configurar o próprio servidor para usar o BIND](#16-configurar-o-proprio-servidor-para-usar-o-bind)
22. [Generated by NetworkManager](#generated-by-networkmanager)
23. [17. Testar resolução externa](#17-testar-resolucao-externa)
24. [18. Testar através do resolver do sistema](#18-testar-atraves-do-resolver-do-sistema)
25. [19. Testar a partir de outra VM](#19-testar-a-partir-de-outra-vm)
26. [20. Diagnóstico com `tcpdump`](#20-diagnostico-com-tcpdump)
27. [21. Diagnóstico do BIND](#21-diagnostico-do-bind)
28. [22. Diagnóstico de DNS em uma única sequência](#22-diagnostico-de-dns-em-uma-unica-sequencia)
29. [23. Problema encontrado durante a configuração](#23-problema-encontrado-durante-a-configuracao)
30. [24. Proxy HTTP não é Proxy DNS](#24-proxy-http-nao-e-proxy-dns)
31. [25. Configuração final](#25-configuracao-final)
32. [26. Checklist final](#26-checklist-final)
33. [BIND](#bind)
34. [Configuração](#configuracao)
35. [Zona](#zona)
36. [Porta 53](#porta-53)
37. [DNS interno](#dns-interno)
38. [DNS externo](#dns-externo)
39. [Resolver do sistema](#resolver-do-sistema)
40. [Internet](#internet)
41. [27. Resultado](#27-resultado)
